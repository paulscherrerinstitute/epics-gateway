...
namespace TestQueries
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            {
                var data = ctx.ReadLog("cryo-cagw02", new DateTime(2019, 03, 14, 12, 0, 0), new DateTime(2019, 03, 14, 12, 10, 0), "select count(*),sum(packetsize),channel group by channel", 20000);
