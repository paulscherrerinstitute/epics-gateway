...
namespace GWTests
{
    ...
    public class GWChecks
    {
        ...
        public void Monitor()
        {
            ...
            double lastVal = -1;
            channel.MonitorChanged += delegate(Channel<double> sender, double newValue)
            {
                lastVal = newValue;
                evt.Set();
            };
        ...
        public void TwoMonitors()
        {
            ...
            double lastValA = -1;
            channelA.MonitorChanged += delegate(Channel<double> sender, double newValue)
            {
                lastValA = newValue;
                evtA.Set();
            };
            ...
            double lastValB = -1;
            channelB.MonitorChanged += delegate(Channel<double> sender, double newValue)
            {
                lastValB = newValue;
                evtB.Set();
            };
        ...
        public void TwoMonitorsConstant()
        {
            var pv = server.CreateRecord<CADoubleRecord>("GWTEST:DBL");
            pv.Value = 1;
            pv.Scan = EpicsSharp.ChannelAccess.Constants.ScanAlgorithm.HZ2;
            ...
            double lastValA = -1;
            int nbChangesA = 0;
            channelA.StatusChanged += delegate(Channel sender, ChannelStatus newStatus)
            {
                nbChangesA++;
            };
            channelA.MonitorChanged += delegate(Channel<double> sender, double newValue)
            ...
            double lastValB = -1;
            int nbChangesB = 0;
            channelB.StatusChanged += delegate(Channel sender, ChannelStatus newStatus)
            {
                nbChangesB++;
            };
            channelB.MonitorChanged += delegate(Channel<double> sender, double newValue)
        ...
        public void ReconnectServerMonitor()
        {
            ...
            double lastVal = -1;
            int stateChange = 0;
            channel.StatusChanged += delegate(Channel sender, ChannelStatus newStatus)
            {
                stateChange++;
            };
            channel.MonitorChanged += delegate(Channel<double> sender, double newValue)
